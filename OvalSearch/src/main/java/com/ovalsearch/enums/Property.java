...
public enum Property {
    ...
    FILE_DOWNLOAD_TIME("file.download.time", "05:00"), SCHEDULER_THREAD_POOL_SIZE("scheduler.thread.pool.size", "1"), CACHE_RELOAD_PASSWORD("cache.reload.password", "ovalsearch"), FILE_DOWNLOAD_PERIOD(
            ...
            "result.limit", "20"), ALL_APPLICATIONS_QUERY("all.applications.query",
            "Select applications from Applications applications where compatibility = true order by downloads DESC, rating DESC"), ENABLE_TASK("enable.task", "false");
